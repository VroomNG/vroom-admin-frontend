...
export class AddDriverComponent implements OnInit {
  ...
  pagePath: any;
  InsuranceType: any;
  licenceType: any; otherDocType: any; multiDocType: any; reportType:any;
  filepath: any = '';
  siteURL: any;
  filename: any;
  ...
  ngOnInit() {
    ...
    this.loginService.addInteraction(sessionStorage.getItem('email'),"Viewed Add Driver ").subscribe((result:any) => {});
  ...
  createForm() {
    ...
    this.driverForm = this.formBuilder.group({
      ...
      phone_no: [this.driverDetails.phone_no, [Validators.required, Validators.minLength(11), Validators.maxLength(15)]],
      ...
      licence_no: [this.driverDetails.licence_no, [Validators.required]],
      vehicle_type: [this.driverDetails.vehicle_type, [Validators.required]],
      ...
      licence_docu: [this.driverDetails.licence_docu, [Validators.required]],
      insurance_docu: [this.driverDetails.insurance_docu, [Validators.required]],
      other_docu: [this.driverDetails.other_docu],
      report:[this.driverDetails.report],
    ...
    this.service.getSingleDriver(this.driverDetails.id).subscribe((response: any) => {
      if (response) {        
        ...
        if (this.driverDetails.id > 0) {
          ...
          this.driverDetails.report = response.data[0].report;
          ...
          this.filepathreport = response.data[0].report;
          this.pdfEmbed = "https://drive.google.com/viewerng/viewer?embedded=true&url=https://vroomng.com:3000"+'/'+this.filepathreport;
          //this.trustedUrl = $sce.trustAsResourceUrl(this.pdfEmbed);
  ...
  addDriver() {
    ...
    if (this.driverForm.invalid) {
      ...
      const inputRequest = {
        ...
        licence_no: this.driverForm.value.licence_no,
        ...
        report: { filetype: this.reportType, fileurl: this.filepathreport, status: "pending", file_name: "rep" }
      };
  ...
  uploadFileToActivity(id:any, filename:any) {
    ...
    if (fileurl != undefined && fileurl != '' && fileurl != null) {
      ...
      else if (filename == 'rep')
        this.reportType = this.filetype;
      else
