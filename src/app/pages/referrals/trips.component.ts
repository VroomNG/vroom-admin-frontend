...
export class RefComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.loginService.addInteraction(sessionStorage.getItem('email'),"Viewed Referrals ").subscribe((result:any) => {});
  ...
  getTripsView(fromDate,toDate) {
    ...
    this.service.getReferralLists().subscribe((result: any) => {
      debugger;
      this.tripsList = [];
      if (result) {
          ...
          if (result.data != undefined) {
            ...
            for (let i = 0; i < result.data.length; i++) {
              ...
              this.tripsList.push({
                ...
                "referee": result.data[i].referee,
                "earned": result.data[i].earned,
